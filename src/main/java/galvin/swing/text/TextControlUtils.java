...
public class TextControlUtils {
    ...
    public static void replaceLine( JTextComponent component, int line, String text ) {
        Document doc = component.getDocument();

        int lineStart = DocumentUtils.getLineStartOffset( doc, line );
        int lineEnd = DocumentUtils.getLineEndOffset( doc, line );
        if( lineEnd >= doc.getLength() ) {
            lineEnd = doc.getLength();
        }

        component.setCaretPosition( lineStart );
        component.moveCaretPosition( lineEnd );
        component.replaceSelection( text );
        component.setCaretPosition( lineStart + text.length() );
    }
    ...
    public static void bookendLine( JTextComponent component, String text, String padding ) {
        try {
            Document doc = component.getDocument();
            int caretPosition = component.getCaretPosition();
            int currentLine = DocumentUtils.getLineNumber( doc, caretPosition );

            padding = StringUtils.neverNull( padding );
            String line = DocumentUtils.getLineText( doc, currentLine );
            String lineEnding = line.endsWith( "\n" ) ? "\n" : "";

            String result = text + padding + line.trim() + padding + text + lineEnding;
            replaceLine( component, currentLine, result );
        }
        catch( Throwable t ) {
            t.printStackTrace();
        }
    ...
    /**
     * Sets the selection to either bold or normal, depending on the boolean
     * value pased.
     */
    ...
    /**
     * If any part of the selection is currently not bold, the entire selection
     * will be bolded, otherwise, the entire selection will be unbolded.
     */
    ...
    /**
     * Sets the selection to either italic or normal, depending on the boolean
     * value pased.
     */
    ...
    /**
     * If any part of the selection is currently not italic, the entire
     * selection will be italiced, otherwise, the entire selection will be
     * unitaliced.
     */
    ...
    /**
     * If any part of the selection is currently not underline, the entire
     * selection will be underlineed, otherwise, the entire selection will be
     * ununderlineed.
     */
    ...
    /**
     * If any part of the selection is currently not strikeThrough, the entire
     * selection will be strikeThroughed, otherwise, the entire selection will
     * be unstrikeThroughed.
     */
    ...
    /**
     * If any part of the selection is currently not superscript, the entire
     * selection will be superscripted, otherwise, the entire selection will be
     * unsuperscripted.
     */
    ...
    /**
     * If any part of the selection is currently not subscript, the entire
     * selection will be subscripted, otherwise, the entire selection will be
     * unsubscripted.
     */
